...
const qtWriteUser = (data) => {
  return fetch(`https://stupefied-elion-621b07.netlify.app/.netlify/functions/qtWriteUser`, {
    body: JSON.stringify(data),
    method: 'POST'
  }).then(response => {
    return response.json()
...
const qtUpdateUser = (data) => {
  return fetch(`https://stupefied-elion-621b07.netlify.app/.netlify/functions/qtUpdateUser`, {
    body: JSON.stringify(data),
    method: 'POST'
  }).then(response => {
    return response.json()
...
export default  {
  ...
  qtUpdateUser: qtUpdateUser,
  qtWriteUser: qtWriteUser
}
